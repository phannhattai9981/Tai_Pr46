...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="http://localhost:8080/Tai_Pr46/">Home</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                  ...
                  <li class="nav-item active">
                                            <a class="nav-link" href="newCategory">newCategory <span class="sr-only">(current)</span></a>
                 </li>
        ...
        <tbody>
            <c:forEach var="book" items="${bookList}" varStatus="index">
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-secondary" onclick="location.href='edit/${book.id}'">Edit</button>
                        <button type="button" class="btn btn-success" onclick="location.href='delete/${book.id}'">Dalete</button>
                    </td>
